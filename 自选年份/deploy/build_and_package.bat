...
powershell -NoProfile -Command "$static=@('city_twin_output\city_twin_viewer.html','city_twin_output\base_core_data.json','city_twin_output\roads_data.json','city_twin_output\base_data.json','city_twin_output\trajectory_data.json','city_twin_output\city_digital_twin.geojson','city_twin_output\buildings_white_model.json','city_twin_output\bev_voxel_3d.json') | Where-Object { Test-Path $_ }; Compress-Archive -Path $static -DestinationPath 'deploy_package.zip' -Update"
