...
print("Started. Waiting 20s...")
time.sleep(20)

stdin, stdout, stderr = client.exec_command("tail -15 /root/autodl-tmp/seg_inference_v6.log; echo '---'; ps aux | grep 'seg_inference' | grep -v grep | head -2; echo 'GPU:'; nvidia-smi --query-gpu=memory.used --format=csv,noheader")
