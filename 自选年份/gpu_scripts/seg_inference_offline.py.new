#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""GPU SegFormer B3 ADE20K 语义分割 - 全类别映射版"""
...
DEVICE = "cpu"  # Blackwell sm_120 not supported by torch 2.5.1
...
# id mapping for key urban classes:
#   6=road, 11=sidewalk, 52=path, 13=earth, 91=Dirt track, 94=land
#   4=tree, 9=grass, 17=plant, 29=field
#   1=building, 25=house, 48=skyscraper
CITY_CLASSES = {
    "building": [1, 25, 48],
    # road now includes earth/Dirt track/land as well
    "road": [6, 11, 52, 13, 91, 94],
    "sidewalk": [11],
    "green": [4, 9, 17, 29],
    "sky": [2],
    "vehicle": [20, 80, 83, 102, 127],   # + bicycle
    "person": [12],
    "water": [21, 26, 60, 109, 128],
}

# Full 150-class color map
# Unmapped classes fall back to gray (80,80,80) in viz
_color_entries = [
    # --- structural ---
    (0,  120,120,120),   # wall
    (1,  180, 50, 50),   # building
    (25, 170, 40, 40),   # house
    (48, 160, 30, 30),   # skyscraper
    (5,  180,175,165),   # ceiling
    (14, 130, 95, 65),   # door
    ...
    (3,  160,130,110),   # floor
    (6,  128,128,128),   # road
    (11, 155,155,155),   # sidewalk
    (52, 140,140,140),   # path
    (13, 150,130,105),   # earth
    (91, 145,125,100),   # Dirt track
    (94, 135,118, 95),   # land
    (46, 170,155,130),   # sand
    (53, 110,100, 90),   # stairs
    (54, 120,110, 95),   # runway
    (62, 160,130,100),   # bridge
    (92, 165,140,105),   # Dirt track 2
    # --- nature ---
    (4,    0,200, 50),   # tree
    (9,    0,180, 30),   # grass
    (17,  30,160, 30),   # plant
...
def save_vis(pred, name, viz_dir):
    try:
        ...
        # Also save overlay: original image + segmentation blend
...
def main():
    log("=" * 60)
    log("SegFormer B3 ADE20K - Full Class Map")
