...
sftp.get('/root/autodl-tmp/streetview_sim_v2/sim_results_v2.json',
          r'e:\xicha gis 智能定位\自选年份\gpu_scripts\results\sim_results_v2.json')
print("JSON downloaded")

# Download all annotated images
samples_dir = r'e:\xicha gis 智能定位\自选年份\gpu_scripts\results\sim_v2_samples'
...
sftp.get('/root/autodl-tmp/sim_v2.log',
          r'e:\xicha gis 智能定位\自选年份\gpu_scripts\results\sim_v2.log')
