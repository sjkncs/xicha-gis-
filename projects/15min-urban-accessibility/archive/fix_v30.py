...
# Line 3313 (index 3312) ends with `"\n` - needs comma
if lines[3312].endswith('"\\n"') or lines[3312].endswith('"\n"'):
    lines[3312] = lines[3312].rstrip('"') + '",'
    print("\nFixed: Added comma to last source line")
elif lines[3312].endswith('"') and not lines[3312].endswith('",'):
    lines[3312] = lines[3312] + ','
    print("\nFixed: Added comma to last source line")
elif lines[3312].endswith('\\n"'):
    lines[3312] = lines[3312].replace('\\n"', '\\n",')
