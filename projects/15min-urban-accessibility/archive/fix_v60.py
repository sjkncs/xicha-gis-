...
# The last source array element ends with:
# ...5C 72 22 0A 20 20 20 5D 2C = \r " LF spaces ], comma
# But there's NO comma after the string before LF!

# Fix: Change 5C 72 22 0A to 5C 72 22 2C 0A (add comma)
