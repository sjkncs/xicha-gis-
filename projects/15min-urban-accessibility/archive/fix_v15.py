...
# The exact bytes from hex dump:
# 20 20 20 20 22 20 7D 2C 0D 0A 20 5D 2C 0D 0A
# = 4-space " 2-space },\r\n 1-space ],\r\n
# Should be:
# 20 20 22 20 7D 2C 0D 0A 20 20 5D 2C 0D 0A
# = 2-space " 2-space },\r\n 2-space ],\r\n
...
if pos >= 0:
    print("Found! Context: %s" % repr(raw[pos-10:pos+len(BROKEN)+20]))
    print("\nApplying fix...")
