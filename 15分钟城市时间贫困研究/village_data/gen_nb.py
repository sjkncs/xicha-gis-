"""
Generate notebook integration cells for fang village data
"""
import os, sys
...
# 写入文件
out_file = os.path.join(VILLAGE_DIR, "replace_village_cell.py")
...
> **注意**：搜房数据为2017年快照，价格和部分小区信息可能已有变化。
> 建议结合深圳市住建局现势数据或大众点评实况数据进行校验。
'''

md_file = os.path.join(VILLAGE_DIR, "replace_village_md.txt")
