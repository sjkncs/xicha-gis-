...
# From the hex dump, the actual bytes are:
# 20 20 20 20 22 20 7D 2C 0D 0A 20 20 20 20 20 5D 2C
# = 4-space " 2-space },\r\n 5-space ],

# So broken is: 4-space " 2-space },\r\n 5-space ],
BROKEN = b'    " },\r\n     ],'
FIXED = b'  },\r\n],'
...
if pos >= 0:
    ...
    print("Not found. Let me try without the leading quote...")
    ...
    for p in patterns:
        ...
        if count > 0:
            ...
            pos = raw.find(p)
            print("    First at %d: %s" % (pos, repr(raw[pos:pos+len(p)+20])))
