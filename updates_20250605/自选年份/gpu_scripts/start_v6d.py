...
client.exec_command("rm -f /root/autodl-tmp/outputs/segmentation/checkpoint.json /root/autodl-tmp/seg_inference_v6.log /root/autodl-tmp/outputs/segmentation/seg_results.csv")
client.exec_command("cd /root/autodl-tmp && nohup python3 seg_inference_v6.py > seg_inference_v6.log 2>&1 &")
print("Started. Waiting 30s...")
time.sleep(30)

stdin, stdout, stderr = client.exec_command(
    "tail -10 /root/autodl-tmp/seg_inference_v6.log; echo '---CSV:'; "
    "wc -l /root/autodl-tmp/outputs/segmentation/seg_results.csv; "
    "echo '---Viz:'; ls /root/autodl-tmp/outputs/segmentation/viz/ | wc -l; "
    "echo '---GPU:'; nvidia-smi --query-gpu=memory.used --format=csv,noheader; "
    "echo '---Recent CSV:'; tail -2 /root/autodl-tmp/outputs/segmentation/seg_results.csv"
)
